namespace MGroup.Tests.DDM
{
    ...
    public class Uniform2DModelBuilderYMajor
	{
		...
		public Uniform2DModelBuilderYMajor()
		{
		...
		public Model BuildModel()
		{
			...
			var meshGenerator = new UniformMeshGenerator2DYMajor<Node>(0, 0, DomainLengthX, DomainLengthY,
			...
			{ 
				for (int j = 0; j < NumSubdomainsY; ++j)
				{
					...
					boundaries[i * NumSubdomainsY + j] = new Rectangle(minX, minY, maxX, maxY);
				}
			}
