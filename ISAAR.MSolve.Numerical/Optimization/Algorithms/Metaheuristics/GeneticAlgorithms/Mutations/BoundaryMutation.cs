...
namespace ISAAR.MSolve.Numerical.Optimization.Algorithms.Metaheuristics.GeneticAlgorithms.Mutations
{
        ...
        private void CanonicalVersion(Individual<double>[] population)
        {
            ...
            foreach (var individual in population)
            {
                ...
                for (int gene = 0; gene < genesCount; ++gene)
                {
                    ...
                    {
                        chromosome[gene] = rng.NextBoolean() ? upperBounds[gene] : lowerBounds[gene];
                    }
                }
            }
        }
