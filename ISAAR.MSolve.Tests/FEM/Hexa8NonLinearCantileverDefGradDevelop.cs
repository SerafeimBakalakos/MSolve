...
{
    public static class Hexa8NonLinearCantileverDefGradDevelop
    {
    ...
    { 0,7.975944951878896600e-02 }, {11,-6.715222916021290600e-02 }, {23,-1.400036636464831200e-01 }, {35,-2.194844883932760600e-01 }, {47,-2.998045884933974200e-01 }};
        ...
        private static TotalDisplacementsPerIterationLog SolveModel()
        {
            ...
            var increments = 2;
            var childAnalyzerBuilder = new LoadControlAnalyzerDevelop.Builder(model, solver, provider, increments);
            ...
            LoadControlAnalyzerDevelop childAnalyzer = childAnalyzerBuilder.Build();
