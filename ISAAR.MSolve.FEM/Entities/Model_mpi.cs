...
//{
//    public class Model_mpi : IStructuralModel
//    {
...
//        {
//            throw new NotImplementedException("Must be parallelized");
...
//        {
//            if (TimeDependentNodalLoads.Count < 1) return;
//            throw new NotImplementedException("Must be parallelized");
...
//        {
//            if (ElementMassAccelerationLoads.Count < 1) return;
//            throw new NotImplementedException("Must be parallelized");
...
//            // Send elements to subdomains asynchronously

//            //TODO: Perhaps first send the subdomains and then call subdomain.DefineNodesFromElements() asynchronously
