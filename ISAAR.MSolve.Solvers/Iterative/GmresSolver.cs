...
namespace ISAAR.MSolve.Solvers.Iterative
{
    public class GmresSolver : SingleSubdomainSolverBase<CsrMatrix>
    {
        ...
        private GmresSolver(IStructuralModel model, GmresAlgorithm gmresAlgorithm, IPreconditionerFactory preconditionerFactory, 
        ...
        public class Builder
        {
            ...
            public GmresSolver BuildSolver(IStructuralModel model)
