...
namespace ISAAR.MSolve.Solvers.DomainDecomposition.Dual.FetiDP.Matrices
{
    ...
    /// </summary>
    public class FetiDPSubdomainMatrixManagerSkyline : IFetiDPSubdomainMatrixManager
    {
        ...
        public FetiDPSubdomainMatrixManagerSkyline(ISubdomain subdomain, IReorderingAlgorithm reordering)
        {
