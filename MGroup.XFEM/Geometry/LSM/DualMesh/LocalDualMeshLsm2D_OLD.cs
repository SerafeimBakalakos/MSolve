...
namespace MGroup.XFEM.Geometry.LSM.DualMesh
{
    ...
    /// </summary>
    public class LocalDualMeshLsm2D_OLD : DualMeshLsm2DBase_OLD
    {
        private readonly double farNodeDistance;
        protected readonly Dictionary<int, double> nodalLevelSets;

        public LocalDualMeshLsm2D_OLD(int id, IDualMesh dualMesh, ICurve2D closedCurve) : base(id, dualMesh)
        {
        ...
        {
            if (otherGeometry is LocalDualMeshLsm2D_OLD otherLsm)
            {
