...
namespace MGroup.XFEM.Geometry.LSM
{
    ...
    /// </summary>
    public class LsmElementIntersection2D_NEW : IElementDiscontinuityInteraction
    {
        private readonly IntersectionMesh2D_NEW intersectionMesh;

        public LsmElementIntersection2D_NEW(int parentGeometryID, RelativePositionCurveElement relativePosition, 
            IXFiniteElement element, IntersectionMesh2D_NEW intersectionMesh)
        {
        ...
        {
            var meshCartesian = new IntersectionMesh2D_NEW();
