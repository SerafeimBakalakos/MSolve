...
{
    public class HollowLsmPhase_OLD : LsmPhase_OLD
    {
        ...
        public HollowLsmPhase_OLD(int id, PhaseGeometryModel_OLD geometricModel, int mergeLevel) : base(id, geometricModel, mergeLevel)
        {
        }
        ...
        public override bool UnionWith(IPhase otherPhase)
        {
            ...
            if (otherPhase is HollowLsmPhase_OLD otherHollowPhase)
            {
