...
namespace MGroup.XFEM.Integ.Quadratures
{
    ...
    /// </summary>
    public sealed class PyramidQuadrature: IQuadrature
	{
		public static readonly PyramidQuadrature Points5 = new PyramidQuadrature(
			new GaussPoint(new double[] { 0.5, 0, 0.1531754163448146 }, 2.0 / 15.0),
			new GaussPoint(new double[] { 0, 0.5, 0.1531754163448146 }, 2.0 / 15.0),
			new GaussPoint(new double[] { -0.5, 0, 0.1531754163448146 }, 2.0 / 15.0),
			new GaussPoint(new double[] { 0, -0.5, 0.1531754163448146 }, 2.0 / 15.0),
			new GaussPoint(new double[] { 0, 0, 0.6372983346207416 }, 2.0 / 15.0));

		public static readonly PyramidQuadrature Points6 = new PyramidQuadrature(
			new GaussPoint(new double[] { 0.5702963741068025, 0, 0.1666666666666666 }, 0.1024890634400000),
			new GaussPoint(new double[] { 0, 0.5702963741068025, 0.1666666666666666 }, 0.1024890634400000),
			new GaussPoint(new double[] { -0.5702963741068025, 0, 0.1666666666666666 }, 0.1024890634400000),
			new GaussPoint(new double[] { 0, -0.5702963741068025, 0.1666666666666666 }, 0.1024890634400000),
			new GaussPoint(new double[] { 0, 0, 0.08063183038464675 }, 0.1100000000000000),
			new GaussPoint(new double[] { 0, 0, 0.6098484849057127 }, 0.1467104129066667));
