...
//        /// </summary>
//        private ElasticMaterial3D[] materialsAtGPsBulk;

//        private int numEnrichedDofs;

//        public XCrackElement3D(int id, IReadOnlyList<XNode> nodes, double thickness, IElementGeometry elementGeometry,
...
//        public (IReadOnlyList<GaussPoint>, IReadOnlyList<ElasticMaterial3D>) GetMaterialsForBulkIntegration()
...
//            this.materialsAtGPsBulk = new ElasticMaterial3D[numPointsVolume];
//            for (int i = 0; i < numPointsVolume; ++i)
//            {
