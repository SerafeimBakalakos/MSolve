...
//        private Dictionary<PhaseBoundary2D, IReadOnlyList<GaussPoint>> gaussPointsBoundary;
...
//        /// </summary>
//        private Dictionary<PhaseBoundary2D, ThermalInterfaceMaterial[]> materialsAtGPsBoundary;
...
//        /// In the same order as their corresponding <see cref="gaussPointsVolume"/>.
//        /// </summary>
//        private IPhase2D[] phasesAtGPsVolume;

//        public XThermalElement2D(int id, IReadOnlyList<XNode> nodes, double thickness, IThermalMaterialField2D materialField,
//            IIsoparametricInterpolation2D interpolation, IGaussPointExtrapolation2D gaussPointExtrapolation,
//            IQuadrature2D standardQuadrature, IBulkIntegration bulkIntegration, int boundaryIntegrationOrder)
//        {
//            this.id = id;
//            this.Thickness = thickness;
//            this.Nodes = nodes;
//            this.Interpolation2D = interpolation;
...
//        public CellType CellType => Interpolation2D.CellType;
...
//                    for (int i = 0; i < Nodes.Count; ++i)
//                    {
//                        NaturalPoint node1 = Interpolation2D.NodalNaturalCoordinates[i];
//                        NaturalPoint node2 = Interpolation2D.NodalNaturalCoordinates[(i + 1) % Nodes.Count];
//                        edges[i] = (node1, node2);
//                    }
//                    return edges;
//                }
...
//        /// </summary>
//        public IIsoparametricInterpolation2D Interpolation2D { get; }
//        public IIsoparametricInterpolation3D Interpolation3D { get; }

//        public IThermalMaterialField2D MaterialField { get; }
...
//        {
//            // Volume integration
//            this.gaussPointsVolume = IntegrationBulk.GenerateIntegrationPoints(this);
...
//            {
//                evalInterpolationsAtGPsVolume[i] = Interpolation2D.EvaluateAllAt(Nodes, gaussPointsVolume[i]);
//            }
...
//            Vector totalShapeFunctions = Vector.CreateZero(numEnrichedDofs);
//            double[] N = Interpolation2D.EvaluateFunctionsAt(gaussPoint);
//            int idx = 0;
//            for (int n = 0; n < Nodes.Count; ++n)
//            {
//                XNode node = Nodes[n];
