...
{
    public class LsmCrack2DExterior : ICrack
    {
        ...
        public LsmCrack2DExterior(int id, PolyLine2D initialCrack, XModel<IXCrackElement> model, IPropagator propagator)
        {
            this.ID = id;
        ...
        public IList<EnrichmentItem> DefineEnrichments(int numCurrentEnrichments)
        {
            ...
            var tipEnrichment = new IsotropicBrittleTipEnrichments2DExplicit(() => lsmGeometry.TipSystem);
