...
namespace MGroup.Solvers.DomainDecomposition.Partitioning
{
    public class UniformMeshPartitioner3D : IPartitioner
    {
        ...
        private readonly UniformMesh3D mesh;
        ...
        public UniformMeshPartitioner3D(UniformMesh3D mesh, int[] numSubdomains, int[] numClusters)
        {
            this.mesh = mesh;
        ...
        public void Partition(IStructuralModel model)
        {
            PartitionElements();
