...
using MGroup.Solvers_OLD.DistributedTry1.Distributed.LinearAlgebra.IterativeMethods.PCG;
...
namespace MGroup.Solvers_OLD.DistributedTry1.Distributed.LinearAlgebra.IterativeMethods
{
    /// <summary>
