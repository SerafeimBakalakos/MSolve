...
namespace MGroup.Solvers_OLD.DistributedTry1.Distributed.LinearAlgebra.IterativeMethods.PCG
{
    /// <summary>
    ...
    public interface IPcgResidualUpdater
    {
        ...
        void UpdateResidual(PcgAlgorithmBase pcg, IIterativeMethodVector residual);
    }
}
