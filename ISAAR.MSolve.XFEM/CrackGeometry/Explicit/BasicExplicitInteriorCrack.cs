...
namespace ISAAR.MSolve.XFEM_OLD.CrackGeometry.Explicit
{
    class BasicExplicitInteriorCrack
    {
        ...
        private LinkedList<CartesianPoint> Vertices { get; }
        ...
        public void UpdateEnrichments()
        {
            ...
            var startTipNodes = new HashSet<XNode>();
            var endTipNodes = new HashSet<XNode>();
        ...
        private void ApplyEnrichmentFunctions(HashSet<XNode> bodyNodes, HashSet<XNode> startTipNodes, 
            HashSet<XNode> endTipNodes)
        {
        ...
        private void FindBodyAndTipNodesAndElements(HashSet<XNode> bodyNodes, HashSet<XNode> startTipNodes, 
            HashSet<XNode> endTipNodes)
        {
