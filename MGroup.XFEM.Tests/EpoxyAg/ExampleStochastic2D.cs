    ...
    public class ExampleStochastic2D
    {
        ...
        public void Run()
        {
            try
            {
                ...
                IMatrix conductivity = Analysis.RunHomogenizationAnalysis2D(model, minCoords, maxCoords, thickness);
        ...
        private GeometryPreprocessor2D CreatePhases(XModel model, BiMaterialField materialField)
        {
