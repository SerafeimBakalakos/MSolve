...
namespace MGroup.XFEM.Tests.MultiphaseStructural
{
    public class HalfAndHalf2D
    {
        private static readonly string outputDirectory = Path.Combine(
            Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, "Resources", "half_half_2D_temp");
        private static readonly string expectedDirectory = Path.Combine(
            Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, "Resources", "half_half_2D");
        ...
        private const double cohesivenessMode1 = 1E8, cohesivenessMode2 = 1E8;
