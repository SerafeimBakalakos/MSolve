...
{
    public class HalfAndHalf3D
    {
        private static readonly string outputDirectory = @"C:\Users\Serafeim\Desktop\HEAT\elasticity\half_half_3D";
        ...
        {
            List<ISurface3D> discontinuities = Utilities.Phases.CreateHalfSpace3D(minCoords, maxCoords, true);
            PhaseGeometryModel geometryModel = Utilities.Phases.CreateLsmPhases3D(model, discontinuities);
