...
{
    public class CollocationModel: IStructuralAsymmetricModel
    {
        ...
        private readonly Dictionary<int, ICollocationElement> elementsDictionary = new Dictionary<int, ICollocationElement>();
        private readonly Dictionary<int, CollocationPatch> patchesDictionary = new Dictionary<int, CollocationPatch>();
        ...
        private void AssignConstraints()
        {
            ...
            foreach (var patch in PatchesDictionary.Values) patch.ExtractConstraintsFromGlobal(Constraints);
        }
