...
namespace MGroup.Solvers_OLD.DistributedTry1.Distributed.LinearAlgebra.IterativeMethods.Preconditioning
{
    /// <summary>
    ...
    public class IdentityPreconditioner: IPreconditioner
    {
        ...
        /// <summary>
        /// See <see cref="IPreconditioner.SolveLinearSystem(DistributedOverlappingVector, DistributedOverlappingVector)"/>.
        /// </summary>
        /// <remarks>
