...
namespace ISAAR.MSolve.XFEM.Tests.Transfer
{
    ...
    {
        public static void TestDcbModelTransfer(string[] args)
        {
            using (new MPI.Environment(ref args))
            {
                TestModelTransfer(27, CreateDcbModel27);
            }
        }
        ...
        private static void TestModelTransfer(int numProcesses, Func<XModel> createModel)
        {
            int master = 0;
            ...
            var model = new XModelMpi(procs, createModel, DcbBenchmarkBelytschko.ElementFactory);
        ...
        private static XModel CreateDcbModel27()
        {
            int numElementsY = 15;
