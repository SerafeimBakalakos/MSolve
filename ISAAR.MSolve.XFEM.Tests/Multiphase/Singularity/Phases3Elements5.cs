...
namespace ISAAR.MSolve.XFEM.Tests.Multiphase.Singularity
{
    public static class Phases3Elements5
    {
        ...
        private static GeometricModel CreatePhases()
        {
            ...
            var AB = new PhaseBoundary(new XFEM.Multiphase.Geometry.LineSegment2D(A, B), phase0, phase1);
            var CD = new PhaseBoundary(new XFEM.Multiphase.Geometry.LineSegment2D(C, D), phase1, phase2);
