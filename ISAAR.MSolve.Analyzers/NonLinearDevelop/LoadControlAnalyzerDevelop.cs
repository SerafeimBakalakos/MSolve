...
namespace ISAAR.MSolve.Analyzers.NonLinear
{
    public class LoadControlAnalyzerDevelop : NonLinearAnalyzerBaseDevelop
    {
        ...
        public class Builder: NonLinearAnalyzerBuilderBaseDevelop
        {
            ...
            public LoadControlAnalyzerDevelop Build()
            {
                return new LoadControlAnalyzerDevelop(model, solver, provider, SubdomainUpdaters,
