...
{
    public class BinaryEncoding : IEncoding
    {
        ...
        public BinaryEncoding(int continuousVariablesCount, double[] continuousLowerBounds, double[] continuousUpperBounds, 
        ...
        public double[] Phenotype(bool[] genotype)
        {
            ...
            for (int i = 0; i < continuousVariablesCount; ++i)
            {
                ...
                int deci = BinaryUtilities.BinaryToDecimal(genotype, start, bitsPerContinuousVariable);
        ...
        public int[] IntegerPhenotype(bool[] genotype)
        {
            ...
            for (int i = 0; i < integerVariablesCount; ++i)
            {
                ...
                integerVariables[i] = BinaryUtilities.BinaryToDecimal(genotype, start, bitsPerIntegerVariable);
            }
